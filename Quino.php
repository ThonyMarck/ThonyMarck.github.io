...
<html>
  ...
  <head >
    ...
    <link rel="stylesheet" href="Quino.css" type="text/css">
  </head>
  ...
  <body>
   ...
   <?php
    ...
    $sql = "SELECT * FROM paquetes WHERE nombre = 'Quino 1'";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<img  src='cuadroquino.png' class='cuadroquino'>";
            echo "<br>";
            ...
            echo "<img  src='rosaocaja.png' class='rosaocaja'>";
    ...
    <?php
        ...
        // Query para recuperar datos de la tabla (cambia 'mi_tabla' por el nombre de tu tabla)
        $sql = "SELECT * FROM paquetes WHERE nombre = 'Quino 2'";
        $result = $conn->query($sql);
    ...
    <?php
        ...
        // Query para recuperar datos de la tabla (cambia 'mi_tabla' por el nombre de tu tabla)
        $sql = "SELECT * FROM paquetes WHERE nombre = 'Quino 3'";
        $result = $conn->query($sql);
    ...
    <?php
        ...
        // Query para recuperar datos de la tabla (cambia 'mi_tabla' por el nombre de tu tabla)
        $sql = "SELECT * FROM paquetes WHERE nombre = 'Quino 4'";
        $result = $conn->query($sql);
